 ...
 * Original file: C:\\Users\\Hasan\\Dropbox\\! I.T Degree Documents\\COSC2408 Prog Project 1\\Workspace\\LauncherActivity\\src\\com\\cellbots\\local\\IRobotControllerService.aidl
 */
...
@Override public void connect(java.lang.String username, java.lang.String robotBtName, java.lang.String robotBtAddr) throws android.os.RemoteException
{
...
@Override public void sendCommand(java.lang.String cmd) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public byte[] getSensorData(int sensorType) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
byte[] _result;
...
@Override public java.lang.String getPose() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public java.lang.String getOdometer(boolean reset) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public void resetOdometer() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public java.lang.String getStateJson() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
